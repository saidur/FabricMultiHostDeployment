...
app.use(expressJWT({
    ...
    path: ['/users','/users/login', '/register','/test']
}));
...
app.use((req, res, next) => {
    ...
    //token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2MDU1NjM1OTQsInVzZXJuYW1lIjoic2FpZHVyIiwib3JnTmFtZSI6Ik9yZzEiLCJpYXQiOjE2MDU1Mjc1OTR9.lEMXcE-emgDyewBnHYu4eYIy5ZvhzDv4v8Bl8fo9K6o'
    token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2MDU2MzI2NjMsInVzZXJuYW1lIjoic2FpZHVyIiwib3JnTmFtZSI6Ik9yZzEiLCJpYXQiOjE2MDU1OTY2NjN9.R8NfGxrWRVxNuCShrCiRvlnsmAKC4rQO2liyikxLPSo';
